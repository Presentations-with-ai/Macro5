...
const AGREEMENT_TEXT_HTML = `
      ...
      <p class="agreement-doc-meta">Вступление в силу: после нажатия "Принять"<br>Telegram-бот: Macroquiz<br>Владелец бота: Sayfiddinov™<br>Контакты: @SayfiddinovM</p>
      <h4 class="agreement-doc-section">1. Общие положения</h4>
      <p>1.1. Настоящее Пользовательское соглашение (далее - «Соглашение») регулирует порядок использования Telegram-бота Macrouiz (далее - «Бот»), содержащего тесты, задания, обучающие материалы, интерфейсы прохождения тестирования, подсчет результатов, статистику, а также иные связанные сервисы и функции.</p>
      ...
      <p>2.1. Бот - Telegram-бот Macroquiz, включая все диалоги, команды, встроенные кнопки, сообщения, сценарии, программный код, базы данных, тесты, результаты, визуальные элементы, тексты, изображения, скрипты и иные компоненты.</p>
